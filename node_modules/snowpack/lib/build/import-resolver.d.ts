...
export declare function getImportStats(importedFileOnDisk: string): fs.Stats | false;
/**
 ...
 */
export declare function createImportResolver({ fileLoc, lockfile, config, }: ImportResolverOptions): (spec: string) => string | false;
export {};
