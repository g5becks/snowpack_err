...
export declare const unstable__startDevServer: () => never;
/** @deprecated: Promoted to loadAndValidateConfig() **/
export declare const unstable__loadAndValidateConfig: () => never;
/** @deprecated: Promoted to getUrlForFile() **/
export declare const unstable__getUrlForFile: () => never;
