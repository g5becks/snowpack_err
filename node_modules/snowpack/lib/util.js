...
function isRemoteSpecifier(specifier) {
    return specifier.startsWith('//') || url_1.default.parse(specifier).protocol;
}
exports.isRemoteSpecifier = isRemoteSpecifier;
/**
