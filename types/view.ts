...
import type { CSSSelector } from 'framework7/components/app/app-class'
...
type Props = Partial<{
  ...
  routesBeforeEnter(to: Router.Route, from: Router.Route, resolve: () => void, reject: () => void): void
  ...
  routesBeforeLeave(to: Router.Route, from: Router.Route, resolve: () => void, reject: () => void): void
  ...
  /**	If "true" then URLs like "about.htmlid=2" and "about.htmlid=3" will be treated and cached like single "about.html" page */
...
type Events = {
  viewInit: View
  viewResize: number | string
  swipebackMove: unknown
  swipeBackBeforeChange: unknown
  swipeBackAfterChange: unknown
  swipeBackBeforeReset: unknown
  swipeBackAfterReset: unknown
  tabShow: undefined
  tabHide: undefined
}

export class View extends SvelteComponentTyped<Props, Events> {}
